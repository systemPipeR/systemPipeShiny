######################SPS Data Tab Title tab######################
## creation date: 2020-09-09 16:03:46
## Author: 

# data_b UI
data_bUI <- function(id){
    ns <- NS(id)
    ...
    tagList(
        ...
        tabTitle("Title for Data Tab Title"), spsHr(),
...
data_bServer <-function(id, shared){
...
github = c('')
        ...
        data_df <- reactive({
            ...
            loadDF(choice = input$data_source, upload_path = df_path$datapath,
                   ...
                   eg_path = '/home/lz/Desktop/systemPipeShiny/SPS_20200909/data/iris.csv')
        })
        # display table
