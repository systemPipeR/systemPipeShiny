...
and can later be displayed on the Canvas. For example, there is a plotting option to 
choose 5 samples on the plot and then you take a snapshot1. When this snapshot1 is displayed 
on the Canvas, there will be 
