...
Then, to launch the SPS app, run:
...
SPS project is created. Custom changes can be made inside this file before the app launches. 
...
The [advanced section](#extend-sps) will teach you how to create your own tabs.
...
All SPS tabs are well classified into WF and VS part. We will start from WF.
...
files. One should save these files and run a workflow in SPR. Directly running a SPR workflow 
