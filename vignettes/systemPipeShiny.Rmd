...
Dani:My opinion here is that if we mentioned some plot here, 
we should provide the plots on the visualization tabs since we already have these plots organized.</font>
LZ: these tabs have been moved to the *spsBio* plugin (a sub repo) to reduce the complexity
of the main package. Introducing these tabs back will dramatically increase the 
package complexity and another ~100 package dependencies (89 for now, ~170 after).
For the submission, I think we want to keep it as simple as possible. I suggest we 
either remove this sentence or only say "The present suite of pre-configured 
visualization examples include different methods to plot a count table and more."]
